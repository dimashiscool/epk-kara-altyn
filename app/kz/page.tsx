      ...
      <div className="min-h-screen text-stone-900">
        ...
        <main className="container-wrap space-y-10 py-8 md:py-10">
          <section id="home" className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm md:p-10">
            ...
            <h1 className="text-4xl font-semibold tracking-tight text-stone-950 md:text-6xl">{filmContent.title}</h1>
            <p className="mt-2 text-lg text-stone-600">{filmContent.productionCompany}</p>
